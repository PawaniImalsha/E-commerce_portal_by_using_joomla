			  ...
			  <h3 class="userItemTitle">
				...
				<div class="jsn-article-toolbar">
					...
					<div class="jsn-article-info">
						...
						<!-- Date created -->
						<div class="createdate"><i class="jsn-icon-calendar"></i><span class="userItemDateCreated"><?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_LC3')); ?></span></div>
						<?php endif; ?>
						...
						<div class="userItemCommentsLink">
							...
							<?php else: ?>
								...
								<i class="jsn-icon-comment1"></i><a href="<?php echo $item->link; ?>#itemCommentsAnchor">
		  ...
		  <div class="userItemBody">
			...
			<div class="userItemReadMore">
					<a class="k2ReadMore" href="<?php echo $item->link; ?>">
						<i class="jsn-icon-link"></i><?php echo JText::_('K2_READ_MORE'); ?>
					</a>
			</div>
			<?php endif; ?>
			</div>
