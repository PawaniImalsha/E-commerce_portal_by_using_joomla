			...
			<div class="tagItemHeader">
				...
				<div class="jsn-article-toolbar">
						<div class="jsn-article-info">
							...
							<div class="createdate"><i class="jsn-icon-calendar"></i><span class="tagItemDateCreated"><?php echo JHTML::_('date', $item->created , JText::_('DATE_FORMAT_LC3')); ?></span></div>
							<?php endif; ?>
							<?php if($item->params->get('tagItemCategory')): ?>
							<!-- Item category name -->
							<div class="tagItemLinks">
								<div class="tagItemCategory"><i class="jsn-icon-folder"></i><a href="<?php echo $item->category->link; ?>"><?php echo $item->category->name; ?></a> </div>
							</div>
							<?php endif; ?>
						</div>
				</div>
