...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock">
	...
	<ul>
		...
		<li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>"> 
			...
			<div class="moduleItemAuthor"><i class="jsn-icon-user"></i><?php echo K2HelperUtilities::writtenBy($item->authorGender); ?>
			...
			<div class="itemDateCreated"><i class="jsn-icon-calendar"></i> <span class="moduleItemDateCreated"> <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC')); ?></span></div>
			<?php endif; ?>
